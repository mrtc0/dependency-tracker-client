...
module DependencyTracker
  class Analysis
    ...
    attr_accessor :analysis_comments
    ...
    def self.openapi_types
      {
        ...
        :'analysis_comments' => :'Array<AnalysisComment>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DependencyTracker::Analysis` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DependencyTracker::Analysis`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'analysis_comments')
        if (value = attributes[:'analysis_comments']).is_a?(Array)
          self.analysis_comments = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @analysis_state.nil?
        invalid_properties.push('invalid value for "analysis_state", analysis_state cannot be nil.')
      end
    ...
    def valid?
      return false if @analysis_state.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          analysis_comments == o.analysis_comments &&
    ...
    def hash
      [analysis_state, analysis_comments, is_suppressed].hash
    end
