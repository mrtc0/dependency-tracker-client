...
module DependencyTracker
  class PortfolioMetrics
    ...
    attr_accessor :vulnerable_projects

    attr_accessor :components

    attr_accessor :vulnerable_components
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DependencyTracker::PortfolioMetrics` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DependencyTracker::PortfolioMetrics`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'vulnerable_projects')
        self.vulnerable_projects = attributes[:'vulnerable_projects']
      end
      ...
      if attributes.key?(:'vulnerable_dependencies')
        self.vulnerable_dependencies = attributes[:'vulnerable_dependencies']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          projects == o.projects &&
          vulnerable_projects == o.vulnerable_projects &&
          components == o.components &&
          vulnerable_components == o.vulnerable_components &&
          dependencies == o.dependencies &&
          vulnerable_dependencies == o.vulnerable_dependencies &&
    ...
    def hash
      [critical, high, medium, low, unassigned, vulnerabilities, projects, vulnerable_projects, components, vulnerable_components, dependencies, vulnerable_dependencies, suppressed, findings_total, findings_audited, findings_unaudited, inherited_risk_score, first_occurrence, last_occurrence].hash
    end
